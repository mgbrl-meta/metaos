...
const criticalFiles = [
  ...
  "vercel.json",
  "docs/METAOS_STEP_7A_DATA_CONNECTION_ARCHITECTURE.md",
  "scripts/metaos-data-connection-architecture-audit.mjs",
  "styles/metaos-ui/data-connections.css",
  "lib/metaos-ui/workspaceNavigationPolicy.ts",
  ...
  "lib/meta-connections/server/bigQueryClients.ts",
  "lib/meta-connections/server/connectionAdmin.ts",
  "lib/meta-connections/server/runtimeEnvironmentManager.ts",
  "lib/meta-connections/contracts.ts",
  "components/metaos-ui/primitives/HeaderStatus.tsx",
  "components/metaos-ui/settings/BigQueryConnectionPanel.tsx",
  "components/metaos-ui/modules/SettingsModule.tsx",
  "app/api/meta-connections/bigquery/sync/route.ts",
  "app/api/meta-connections/bigquery/save/route.ts",
  "app/api/meta-connections/bigquery/test/route.ts",
  "app/api/meta-connections/bigquery/status/route.ts",
  "app/api/cron/meta-sync/route.ts",
  "app/api/meta-bq/route.ts",
  "app/api/meta-data/route.ts",
  "docs/METAOS_ROUTE_HANDLER_ARCHITECTURE.md",
  "scripts/metaos-route-handler-architecture-audit.mjs",
  ...
  "scripts/metaos-analysis-screen-migration-audit.mjs",
  "docs/METAOS_FINAL_RECONCILIATION_6E0.md",
  "scripts/metaos-final-reconciliation-audit.mjs",
  "scripts/metaos-final-frontend-freeze-audit.mjs",
  ...
  "components/metaos-ui/modules/AnalysisLayerShared.tsx",
  ...
  "docs/METAOS_ANALYSIS_LAYER_ENGINE_ARCHITECTURE.md",
  "scripts/metaos-analysis-layer-engine-audit.mjs",
